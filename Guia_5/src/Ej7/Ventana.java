...
public class Ventana extends JFrame implements ActionListener {
	...
	public Ventana() {
		...
		this.brnCrearMago.addActionListener(this);
		...
		if (p1 != null && p2 != null) {
			if (p1 == p2) {
				...
				try {
					...
					double distDeAtaque = e.getAtacante().distanciaMaximaDeDesplazamiento;
					JOptionPane.showMessageDialog(this, p1.getNombre() + " quizo atacar a " + p2.getNombre() + " pero estaba fuera de rango(Distancia Max: "+distDeAtaque+")\n");
				}
