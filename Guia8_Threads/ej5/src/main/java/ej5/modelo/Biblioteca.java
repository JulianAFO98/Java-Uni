...
public class Biblioteca {
    ...
    public synchronized void donarLibro(Libro libADonar, Donador donador) throws InterruptedException {
        while(libros.size() == 10){
            wait();
        }
        System.out.println(donador.getName()+" dono el libro "+libADonar.getIdLibro());
